...
<section>
                ...
                <div class="onasPrvky">
                    <div class="prvkyBox">
                        ...
                        <div class="boxText">
                            ...
                            <p>Věděli jste, že vlastně pijete ovoce, když si vychutnáváte latté?</p>
                            <a class="button" href="#">Více <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                    <div class="prvkyBox">
                        ...
                        <div class="boxText">
                            ...
                            <p>Mezi oblíbené zákusky patří větrníky, věnečky, špičky, kremrole, indiánci, nejrůznější typy řezů, dortíků či rolád.</p>
                            <a class="button" href="#">Více <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                    <div class="prvkyBox">
        ...
        <div class="brown">
            <div class="brownText">
                <div class="brownPopis">
                    <h2>Každé pondělí druhé cappuccino zdarma</h2>
        ...
        <div class="tip">
            <div class="container">
                ...
                <div class="tipText">
                    ...
                    <a class="button" href="#">Číst víc <i class="fas fa-angle-double-right"></i></a>
                </div>
            </div>
        </div>
    </section>
